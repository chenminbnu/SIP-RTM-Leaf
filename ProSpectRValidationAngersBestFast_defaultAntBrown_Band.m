%% Vadliation PROSPECT leaf-scale optical spectra model with in situ Angers dataset for three broadband windows
...
save('BestAngersdatasetProSpect_defaultAntBrown_Band.mat','totalRProSpectVIS','totalRinsituVIS','totalRProSpectNIR','totalRinsituNIR','totalRProSpectSWNIR','totalRinsituSWNIR','totalTProSpectVIS','totalTinsituVIS','totalTProSpectNIR','totalTinsituNIR','totalTProSpectSWNIR','totalTinsituSWNIR');
figure;
