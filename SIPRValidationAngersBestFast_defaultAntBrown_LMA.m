%% Vadliation SIP leaf reflectance model with Lopex dataset;
%% In situe dataset
clear all;
clc;
...
save('BestAngersdatasetSIP_defaultAntBrown_LMA.mat','totalRSIP','totalRinsitu','totalTSIP','totalTinsitu');
